...
Use [GitHub's private vulnerability report form](https://github.com/shipiyouniao/minefarer/security/advisories/new). Include the affected commit or deployed URL, browser or Node.js version, reproduction steps, impact, and a minimal proof of concept when possible.
...
Use your own browser profile and local data when testing. Do not access another person's data or disrupt shared services. Ordinary gameplay bugs and feature requests belong in [public issues](https://github.com/shipiyouniao/minefarer/issues).
