...
export const zhMessages: MessageCatalog = {
  ...
  'story.go-together': '那就先去找她。记录里真有回家的路，也得有人帮我看懂。',
  'story.lift-answer': '两声。妮娅听见了。抓稳扶手，我们上去。',
  'story.brake': '装卸制动器',
  'story.winch': '运货卷扬机',
  ...
  'story.mechanism-locked': '先隔离周围魔结',
  'story.mechanism-help': '标出{name}周围的魔结，打开其余邻格，再点机关操作。',
  'story.mechanism-ready': '{name}已就绪，走过去操作吧。',
  'story.brake-scene-1': '那堆货就悬在矿道口。绳子一直响，这正常吗？',
  'story.brake-scene-2': '不正常。我先撑住它。按拉杆旁的数字清理周围，别让魔结的冲击把货震下来。',
  'story.release-scene-1': '停住了。你可以松手了。',
  'story.release-scene-2': '正有此意。下次我再说“这机器我熟”，记得提醒我这根绳子。',
  'story.winch-scene-1': '完整的轴就在挡板后。卷扬机能把它吊出来，也能把台车送回升降台。',
  'story.winch-scene-2': '我先看地面，你再碰机器。我记住了。',
  'signal.title': '塔内的回应',
  ...
  'signal.complete': '道路已经打开，前往下一处。',
  'signal.entry-1': '……第三次敲管道。听见的话，别敲回来。它会把你也算进去。',
  'signal.entry-2': '有人在里面？露米，这座塔不是已经废弃了吗？',
  'signal.entry-3': '门上的灯还亮着。先断开供能器，我们进去找她。',
  'signal.connected-1': '终于不只是我一个人的回声了。我叫妮娅，修线路的。现在是线路把我关起来了。',
  'signal.connected-2': '撤离程序。请返回登记住址。未登记人员，不得离塔。',
  'signal.connected-3': '我连这个世界的住址都没有。它也不会放我走。',
  'signal.connected-4': '那我们先别填表了。往上走，我替你盯着线路。',
  'signal.archive-1':
    '这层左上是旧登记室。那页蓝封皮的记录，写着“异乡来客”。和你一样，没有本地住址。',
  'signal.archive-2': '他们后来回去了吗？',
  'signal.archive-3':
    '我只读到“返航信标”四个字。侧门还有一条供能线路。你可以绕过去拿，但不用为了它踩雷——我记得信标在哪。',
  'signal.record-1': '“返航试验，第七次。灯已点亮，尚无人回来。”……后面还有一张星图。',
  'signal.record-2': '别折那个角！好吧，等我出去再说。星图比我背下来的地址管用。',
  'signal.prison-1': '看见你们了！最后两条线。别朝守卫扔石头，我试过，它会给石头也发一张登记表。',
  'signal.prison-2': '它在执行早就没人撤销的命令。先把你带出去，再想办法让整座塔醒过来。',
  'signal.rescued-1': '登记住址……未找到。撤离通道……已释放。',
  'signal.rescued-2': '下次我一定把“营地的火堆旁”填进去。谢谢，两个没按流程办事的人。',
  'signal.rescued-3-saved': '星图我会在营地摊开。先找出它指向的夜空，再去找那座返航信标。',
  'signal.rescued-3-skipped':
    '那页记录留在塔里也没关系。我会把记得的路线画在营地。返航信标，我们一起找。',
  'signal.camp-1': '我给自己登记了住址。火堆旁，往右三步。守卫要是追来，你可得替我作证。',
  'signal.camp-2-saved': '这张星图缺了一角，但标了两个观测点。等路修通，我们可以去比对天空。',
  'signal.camp-2-skipped':
    '我记得信标在北边。具体哪条岔路……让我再想想。下次进塔，也许能补回那张星图。',
  'story.north-road': '营地北面的旧路',
  'story.lift': '望楼升降台',
  'story.world-road': '灯栖林地 · 探路',
  'story.road-task': '主线 · 望楼的旧路',
  'story.road-detail': '走到望楼升降台，查明它停下的原因。报酬：20 物资。',
  'story.north-start-1': '昨夜望楼亮过一下。妮娅试灯总会试两次，我一直在想这件事。',
  'story.north-start-2': '亮过一下，至少说明上面有人。我们走近看看。',
  'story.north-found-1': '轴芯断了。断口还亮着，是最近才坏的。',
  'story.north-found-2': '难怪她上得去，下不来。看，车辙往采石场去。那边的机器用的是同一种轴。',
  'story.north-report-1': '升降台是在妮娅上去后坏的，我们找到了通往采石场的车辙。',
  'story.north-report-2': '路线有了。先在这里喘口气，准备好了再去采石场。',
  ...
  'story.quarry-lead': '沿车辙进采石场。旧机器我来认，脚下的魔结拜托你了。',
  'story.spindle-found': '尺寸正好。放上台车！卷扬机已经接上，轨道通到升降台背面。',
  'story.lift-fixed': '扶住这里……好了，转起来了！上面是不是有铃响？',
  'story.tower-arrival': '“撤离令：住址未登记者不得离塔。”妮娅填住址时，从来只写“营地的火堆旁”……',
  ...
  'story.return-bag': '先把她的包放在火边吧。她回来能看到。',
  'story.open-eyes': '睁开眼睛',
  'story.dialogue-next': '继续',
  'story.dialogue-read': '显示整句',
  'story.where-am-i': '刚才那扇门呢？我明明还握着门把手。',
  'story.other-world': '这些数字……我看得懂。可这里的一切我都不认识。',
  'story.found-bag': '搭扣上刻着“妮娅”。里面的绷带还是干的。',
  'story.keep-bag': '是她的。她出门从不丢下这个……能帮我带上吗？',
  'story.home-question': '妮娅也是在找回家的路吗？',
  'story.thanks': '你一直在看北边那条路。',
  ...
  'story.wake-line': '门？这里只剩树根。先别落脚——我刚把你从魔结边拖出来。看那块发亮的「1」。',
  ...
  'story.trail-line': '那就好。我认路，你看地面。试试前面那片空地，没有魔结的地方会连着亮起来。',
  'story.trail-task': '揭开前方空地，再去灯下。路边的遗失行囊可以顺道带上。',
  'story.approach-line': '前面就是营地。火边那张凳子先空着，妮娅总说只有那张不会晃。',
  'story.approach-task': '找一条安全的路走到营地灯下。旗子只标记危险，不会清除魔结。',
  'story.arrival-line': '汤还热着，先喝一点。之后到南边的灯下找我，有件事得跟你说。',
  'story.camp-task': '走到南侧灯下，和露米聊聊。',
  'story.guide-line': '不是。望楼存着异乡来客的记录，她是替我去找旧图的。她答应天黑前回来。',
  ...
  'story.hurt': '魔结爆发了！失去一颗心，危险已经留下标记。',
  'story.fallen': '露米把你带回了安全的地方。歇一会儿，再走这段路吧。',
