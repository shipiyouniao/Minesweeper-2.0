...
export const zhMessages: MessageCatalog = {
  ...
  'story.wake-line': '醒了？先别动。地上的光是魔结留下的痕迹。看得清那个「1」吗？',
  ...
  'story.trail-line':
    '你说自己不属于这里？先找个落脚的地方吧。没有数字的地面会连着显露，试试前面那片。',
  'story.trail-task': '揭开前方空地，再去灯下。路边的遗失行囊可以顺道带上。',
  'story.approach-line': '看，灯栖营地。里面的路都清理过了。到了以后，跟我说说你的故乡吧。',
  'story.approach-task': '找一条安全的路走到营地灯下。旗子只标记危险，不会清除魔结。',
  'story.arrival-line': '到了。火边有热汤，今晚也有地方睡。缓过来以后，到南边的灯下找我吧。',
