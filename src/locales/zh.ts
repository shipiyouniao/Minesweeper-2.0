...
export const zhMessages: MessageCatalog = {
  ...
  'signal.camp-2-saved':
    '图上标着两个看星星的位置，可惜边上缺了一角。等路修好了，咱们去对一对，应该能找出信标在哪儿。',
  'signal.camp-2-skipped':
    '我记得信标在北边，可到了岔路该怎么走……真想不起来了。以后再进塔，咱们把那张星图拿上吧。',
  ...
  'story.north-report-1': '看来还是得去采石场找根轴，不然上不了塔。',
  'story.north-report-2': '嗯。你先歇歇，出发前记得补好东西。',
