...
export const jaMessages: MessageCatalog = {
  ...
  'rail.guide-intro': '数字で道を開き、トロッコを動かそう。',
  'rail.guide-clear':
    '線路にも地雷はある。トロッコは開いた安全なマスだけを進む。緑の線は今回進める道で、未開封のマスを調べることはできない。',
  'rail.guide-route':
    'A/Bを選び、巻き上げ機で動かす。別の枝へ移るには、いったん分岐の入口まで戻り、逆転して入り直そう。押した制動台は開いたままになる。',
  'rail.guide-rescue':
    '最後の階ではトマを乗せ、出発駅まで戻ろう。往路も帰路も安全を確かめる。道を間違えても逆転できる。',
