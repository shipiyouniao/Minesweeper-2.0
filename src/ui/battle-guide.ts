      ...
      : boss.kind === 'brood'
        ...
        : boss.kind === 'mirror'
          ? [
              ...
              {
                text: message(language, 'battle-guide.strike-switch-realms-strike-the-other-twin'),
                prop: 'mirror-dusk',
                symbol: '⇄',
              },
            ]
          : boss.kind === 'magnetic'
            ? [
                ...
                {
                  text: message(language, 'battle-guide.the-crash-breaks-its-armor-approach-and'),
            ...
            : [
                ...
                {
                  text: message(language, 'battle-guide.strike-then-leave-your-echo-it-repeats'),
                  prop: 'player',
                  symbol: '→',
                },
                {
