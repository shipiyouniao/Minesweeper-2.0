...
The existing **roguelite remains available through a temporary entrance**, including its current difficulty choices, bosses and save. Its final Recollection entrance and story-driven content selection will arrive later. The playable story includes the prologue, shared camp, northern road/quarry/lift route and two three-floor watchtower stages. In [An Answer in the Tower](docs/tower-signal-rescue.md), disconnect powered gates, rescue Nia and choose whether to recover an outsider's record. The full chapter is still in progress; see [Roadmap II](https://github.com/shipiyouniao/minefarer/issues/55).
